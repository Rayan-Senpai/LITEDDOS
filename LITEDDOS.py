...
def usage():
    ...
    print "#                                                       #"
    print "#\033[1;91mCreator:Rayan-XD  \033[1;32m##      ###       ##                #"
    print "#\033[1;91mTeam   : Rayan-Senpai        \033[1;32m##     #          ##                #"
...
def flood(victim, vport, duration):
    # Support Rayan-XD ya.. :)
    # Okey Jadi disini gua membuat server, Ketika saya memanggil "SOCK_DGRAM" itu  menunjukkan  UDP type program
